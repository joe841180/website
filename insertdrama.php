				...
				<div class="inner">
					<div class="box">
						<div class="content">
                            ...
                            $sql_insert = "INSERT INTO drama(no,name,country,type,topic,year) VALUES ('$_POST[no]','$_POST[name]','$_POST[country]','$_POST[type]','$_POST[topic]','$_POST[year]')";
                            
                            $result = mysql_query($sql_insert) or die('<h2>新增失敗<h2>');
